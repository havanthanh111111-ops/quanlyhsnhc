                          ...
                          list.map(student => (
                            ...
                            >
                              <div className="flex items-start justify-between gap-1.5">
                                ...
                                {student.avatarUrl ? (
                                  <img 
                                    src={student.avatarUrl.replace('/view?usp=drivesdk', '').replace('file/d/', 'uc?export=view&id=')}
                                    alt={student.name} 
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 items-start">
                ...
                <div className="xl:col-span-3 bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-sm flex flex-col items-center">
                  ...
                  {/* Seat grid */}
                  <div className="w-full overflow-x-auto custom-scrollbar flex justify-center pb-2">
                    <div 
